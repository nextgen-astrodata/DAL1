...
int main (int argc, char *argv[])
{
  ...
  // Processing of command line options ____________________
  ...
  // Check completeness of command line options ____________
  ...
  // Processing of input data ______________________________
