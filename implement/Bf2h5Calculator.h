...
{
	public:
		Bf2h5Calculator(BF2H5 *parent, uint8_t nr_subbands, uint32_t nr_samples_subband);
		~Bf2h5Calculator();

		void allocateMemory(void);
//		bool memoryAllocated(void) const {return memAllocOK;};
		
		void calculateDataBlock(long int blockNr, BFRawFormat::Sample *sampleData);
		...
		void startProcessing(void); // enables the processing of datablock
