...
This class is kept separate from the actual BFRaw class to seperate the data format from the functionality added to the BFRaw data type defined in the BFRaw class while making sure that there is only one location where the format is defined. The BFRaw class is derived from this class.
*/
