...
namespace DAL {
  ...
  */
			   ...
			   void *nulval)
  {
    ...
    /* Compute number of elements in plane */
    nelements=dimensions_p[0]*dimensions_p[1];
...
//   }
  ...
  */
  ...
  /*!
    ...
    \param datatype - data type of the keyword (TSTRING, TLOGICAL==int, TBYTE,
           TSHORT, TUSHORT, TINT, TUINT, TLONG, TULONG, TLONGLONG, TFLOAT,
	   TDOUBLE, TCOMPLEX, TDBLCOMPLEX
  ...
  */
                              ...
                              std::string &card)
  {
    ...
    if (fits_parse_template (const_cast<char *>(templatec.c_str()),
			     const_cast<char *>(card.c_str()),
			     &keytype,
			     &fitsstatus_p))
      {
