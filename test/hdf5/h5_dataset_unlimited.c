/*!
  \file h5_dataset_unlimited.c
  \ingroup HDF5
  \brief Example to show how to create and extend an unlimited dataset

  This example shows how to create and extend an unlimited dataset. The program
  first writes integers to a dataset with dataspace dimensions of DIM0xDIM1, then
  closes the file.  Next, it reopens the file, reads back the data, outputs it to
  the screen, extends the dataset, and writes new data to the extended portions
  of the dataset.  Finally it reopens the file again, reads back the data, and
...
#define FILE            "h5_dataset_unlimited.h5"
#define DATASET         "DS1"
#define DIM0            4
#define DIM1            7
#define EDIM0           6
